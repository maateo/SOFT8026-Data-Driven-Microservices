...
def run():
    with grpc.insecure_channel('tweet-server:50051') as channel:
        ...
        while True:
            for tweet in stub.RequestTweets(Assignment1_pb2.TweetRequest(number_of_tweets=random.randint(1, 15))):
                ...
                print("Tweet analysis client received: ", tweet.target, tweet.id, tweet.date, tweet.flag, tweet.user, tweet.text, flush=True)
